...
#ifndef H_MODJO_SCRIPT
#define H_MODJO_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CmodjoAddress
 */
...
public:
    ...
    // Pre-version-0.6, modjo always counted CHECKMULTISIGs
