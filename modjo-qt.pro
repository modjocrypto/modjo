...
contains(MODJO_NEED_QT_PLUGINS, 1) {
    DEFINES += MODJO_NEED_QT_PLUGINS
...
HEADERS += src/qt/modjogui.h \
    ...
    src/qt/modjoaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/modjo.cpp src/qt/modjogui.cpp \
    ...
    src/qt/modjoaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/modjostrings.cpp \
    src/qt/modjoamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/modjo.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/modjo_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/modjo-qt.rc
...
windows:RC_FILE = src/qt/res/modjo-qt.rc
...
macx:ICON = src/qt/res/icons/modjo.icns
macx:TARGET = "modjo-Qt"
